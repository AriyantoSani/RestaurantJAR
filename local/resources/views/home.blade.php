...
<head>
	...
	<!--
			CSS
			============================================= -->
	<link rel="stylesheet" href="./vendors/homepage/css/linearicons.css">
	<link rel="stylesheet" href="./vendors/homepage/css/font-awesome.min.css">
	<link rel="stylesheet" href="./vendors/homepage/css/availability-calendar.css">
	<link rel="stylesheet" href="./vendors/homepage/css/magnific-popup.css">
	<link rel="stylesheet" href="./vendors/homepage/css/nice-select.css">
	<link rel="stylesheet" href="./vendors/homepage/css/owl.carousel.css">
	<link rel="stylesheet" href="./vendors/homepage/css/bootstrap.css">
	<link rel="stylesheet" href="./vendors/homepage/css/bootstrap-datepicker.css">
	<link rel="stylesheet" href="./vendors/homepage/css/main.css">
</head>
...
<body>
			...
			<div class="header-wrap">
				<div class="header-top d-flex justify-content-between align-items-center navbar-expand-md">
					...
					<div class="col-3 logo">
						<a href="index.html"><img class="mx-auto" src="./vendors/homepage/img/logo.png" alt=""></a>
					</div>
	...
	<script src="./vendors/homepage/js/vendor/jquery-2.2.4.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
	 crossorigin="anonymous"></script>
	<script src="./vendors/homepage/js/vendor/bootstrap.min.js"></script>
	<script src="./vendors/homepage/js/owl.carousel.min.js"></script>
	<script src="./vendors/homepage/js/jquery.sticky.js"></script>
	<script src="./vendors/homepage/js/parallax.min.js"></script>
	<script src="./vendors/homepage/js/jquery.nice-select.min.js"></script>
	<script src="./vendors/homepage/js/jquery.ajaxchimp.min.js"></script>
	<script src="./vendors/homepage/js/jquery.magnific-popup.min.js"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	<script src="./vendors/homepage/js/bootstrap-datepicker.js"></script>
	<script src="./vendors/homepage/js/main.js"></script>
</body>
